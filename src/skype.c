 ...
 *
 * skype.c
 * Nautilus module registering functions for the Skype extension.
 *
...
nautilus_module_initialize (GTypeModule *module) {
  ...
  nautilus_skype_register_type (module);
  type_list[0] = NAUTILUS_TYPE_SKYPE;

  skype_use_nautilus_submenu_workaround
...
nautilus_module_shutdown (void) {
  g_print ("Shutting down skype extension\n");
}
